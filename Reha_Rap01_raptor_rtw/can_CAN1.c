...
void pre_start_CAN_CAN1(void)
{
  ...
  memset((void *)&rxBuf_RxTrig_XCP_BC_CAN1, 0, sizeof(rxBuf_RxTrig_XCP_BC_CAN1));
  rxAge_RxTrig_XCP_BC_CAN1 = MAX_AGE;
  memset((void *)&rxBuf_RxTrig_XCP_CMD_CAN1, 0, sizeof(rxBuf_RxTrig_XCP_CMD_CAN1));
  ...
  * extended, uint8_T *data, uint8_T length)
{
  ...
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (rxLen_RxTrig_XCP_BC_CAN1[rxQTail_RxTrig_XCP_BC_CAN1] == 0) {
      //haven't received anything yet
      memset((void *)&data[0], 0, length);
    } else {
  ...
  * extended, uint8_T *data, uint8_T length)
{
  ...
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (rxLen_RxTrig_XCP_CMD_CAN1[rxQTail_RxTrig_XCP_CMD_CAN1] == 0) {
      //haven't received anything yet
      memset((void *)&data[0], 0, length);
    } else {
