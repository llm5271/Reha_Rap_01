...
#define STOP_SECTION_Mo_CodeCyclicCheck
#include "mo_pragma.h"
#define START_SECTION_Task_oem_rSync
#include "swsh_rb2oem.h"
...
#define STOP_SECTION_Task_oem_rSync
#include "swsh_rb2oem.h"

const T_processPtrTab NewEagle_ASW_krsyn = { &NE_krsyn, END_TASK };

const T_processPtrTab NewEagle_ASW_syn = { &NE_syn, END_TASK };
