...
echo ### Beginning Build for Reha_Rap01_005 ...
...
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\MATLAB\Reha_Rap_01\Reha_Rap01_raptor_rtw\Reha_Rap01_005.hex" /Y
